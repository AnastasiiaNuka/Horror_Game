...
public class enemyMonsterAI : MonoBehaviour
{
    ...
    int randNum; //определение следующего случайного положения аи
    public Transform playerTrans, aiTrans, randDest1, randDest2, randDest3, randDest4, randDest5, randDest6, randDest7, randDest8; //случайные места для монстра, куда он может отправиться 
    public bool walking, chasing, idle; //ходьба преследование или бездействие 
    Vector3 dest; //пункт назначения 
